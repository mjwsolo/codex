...
/// Resolved configuration shared by all localcode SQLite connections.
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl SqliteConfig {
    ...
    /// Open a writable localcode SQLite database, creating it if necessary.
    ...
    /// Open an existing localcode SQLite database without creating or modifying it.
