...
/// One localcode thread/session participating in the rollout.
///
...
/// Provenance for a traced localcode thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the localcode runtime for one thread.
///
/// A localcode turn groups protocol/runtime work for one thread activation.
