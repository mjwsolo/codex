...
/// Runtime operation requested by the model, a JS code cell, or localcode itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the localcode tool boundary.
    ///
    ...
    /// they describe how localcode executed the request, not what the caller sent.
