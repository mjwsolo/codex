...
/// Shared recorder context for inference attempts within one localcode turn.
...
/// Request data for the canonical localcode tool boundary.
...
/// Append-only writer used by hot-path localcode instrumentation.
