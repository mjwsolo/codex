...
impl ThreadTraceContext {
    ...
    ///
    /// Trace startup is best-effort. A tracing failure must not make the localcode
    ...
    /// Emits typed localcode turn lifecycle events from protocol lifecycle events.
    ...
    /// what localcode did while executing that boundary.
    ...
    /// Builds reusable inference trace context for one localcode turn.
    ///
