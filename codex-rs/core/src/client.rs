...
///
/// This holds configuration and state that should be shared across turns within a localcode session
...
///   the same turn.
///
/// Create a fresh `ModelClientSession` for each localcode turn. Reusing it across turns would replay
...
impl ModelClient {
    ...
    ///
    /// All arguments are expected to be stable for the lifetime of a localcode session. Per-turn values
...
impl ModelClientSession {
    ...
    /// Permanently disables WebSockets for this localcode session and resets WebSocket state.
    ///
...
///
/// These headers implement localcode-specific conventions:
///
