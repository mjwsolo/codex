...
/// Selects the MCP extensions localcode supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. localcode retains only the
