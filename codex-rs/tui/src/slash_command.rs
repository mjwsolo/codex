...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for localcode",
            ...
            SlashCommand::Skills => "use skills to improve how localcode performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for localcode",
            ...
            SlashCommand::Permissions => "choose what localcode is allowed to do",
            ...
            SlashCommand::Logout => "log out of localcode",
