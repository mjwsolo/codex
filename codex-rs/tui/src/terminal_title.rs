...
//! "leave the old title alone" or "clear the title localcode last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title localcode manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before localcode started managing the title.
