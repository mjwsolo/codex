...
/// Pick a random tooltip to show to the user when starting localcode.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // localcode currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for localcode TUI.
...
[[announcements]]
content = "Welcome to localcode! Check out the new onboarding flow."
