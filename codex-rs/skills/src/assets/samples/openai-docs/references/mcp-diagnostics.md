...
3. When the current documentation supports it, the local localcode setup is:

   ```sh
   localcode mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
