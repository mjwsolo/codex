...
/// Optional provider-backed features that localcode may expose at runtime.
///
...
pub trait ModelProvider: fmt::Debug + Send + Sync {
    ...
    /// to think through whether localcode should have a unified provider-specific auth
    ...
    /// Returns request credentials, optionally scoped to a localcode session task.
