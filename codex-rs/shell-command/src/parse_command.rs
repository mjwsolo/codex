...
/// The easiest way to iterate is to add unit tests and have localcode fix the implementation.
...
/// Tests are at the top to encourage using TDD + localcode to fix the implementation.
mod tests {
    use super::*;
