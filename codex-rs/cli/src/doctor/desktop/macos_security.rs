...
fn enforcement_check(gatekeeper: Evidence, events: Evidence) -> DoctorCheck {
    ...
    let (status, summary, remedy) = if events == Evidence::Malware {
        (
            ...
            "collect the XProtect detection and ask your security administrator to review the official localcode installation",
        )
        ...
        (
            ...
            "restart your Mac, retry localcode once, and contact support if the problem returns",
        )
